 ...
 *
 * StarbucksActivity will be where we display all location info
 */
...
public class StarbucksActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<StarbucksReviews> reviewsList = StarbucksReviews.readReviewsFromCSV(this);

        // Update the TextView with the information
        StringBuilder reviewsText = new StringBuilder();
        for (StarbucksReviews review : reviewsList) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.reviewButton) {
            i = new Intent(this, StarbucksReviewActivity.class);
            startActivity(i);
        }
