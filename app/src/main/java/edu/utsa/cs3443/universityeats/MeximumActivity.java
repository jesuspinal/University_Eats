 ...
 * MeximumActivity displays reviews for Meximum
 */
...
public class MeximumActivity extends AppCompatActivity implements View.OnClickListener{
    Button reviewButton;
    Button homeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meximum);
        ...
        List<MeximumReview> reviewsList = MeximumReview.readReviewsFromCSV(this);

        // Update the TextView with the information
        StringBuilder reviewsText = new StringBuilder();
        for (MeximumReview review : reviewsList) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.reviewButton) {
            i = new Intent(this, MeximumReviewActivity.class);
            startActivity(i);
        }
