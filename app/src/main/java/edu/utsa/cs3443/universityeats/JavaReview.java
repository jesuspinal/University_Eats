 ...
 * JavaReview class will represent views for javacity
 */
...
public class JavaReview {
     ...
     */
    public JavaReview(String title, String content, String userEmail, String location) {
        this.title = title;
     ...
     */
    public JavaReview(String day, String hours, String description) {
        this.day = day;
        this.hours = hours;
    ...
    // read csv file
    public static List<JavaReview> readReviewsFromCSV(Context context) {
        List<JavaReview> reviewsList = new ArrayList<>();

        try {
            AssetManager assetManager = context.getAssets();
            InputStream inputStream = assetManager.open("Java_City.csv");
            ...
            while (scanner.hasNextLine()) {
                ...
                if (parts.length == 3) {
                    ...
                    JavaReview review = new JavaReview(day, hours, description);
