...
public class SushiReviewActivity extends AppCompatActivity implements View.OnClickListener{

    private static final String PREFS_NAME = "SushiReviewPrefs";
    private static final String KEY_REVIEW_COUNT = "ReviewCount";
    private static final String SUSHI_PREFIX = "sushi_";

    private LinearLayout reviewContainer;
    private List<SushiReview> reviewList;
    ...
    private void displayReviews() {
        for(SushiReview reviews : reviewList){
    ...
    private void loadReviewsFromPreferences() {
        ...
        for(int i = 0; i < reviewCount; i++){
            String title = sharedPreferences.getString(SUSHI_PREFIX + "review_title_" + i, "");
            String content = sharedPreferences.getString(SUSHI_PREFIX + "review_content_" + i, "");

            SushiReview review = new SushiReview();
    ...
    private void createReviewView(final SushiReview review) {
    ...
    private void showDeleteDialog(final SushiReview review) {
    ...
    private void deleteReviewAndRefresh(SushiReview review) {
    ...
    private void saveReviewsToPreferences() {
        ...
        for(int i = 0; i < reviewList.size(); i++){
            SushiReview review = reviewList.get(i);
            editor.putString(SUSHI_PREFIX + "review_title_" + i, review.getTitle());
            editor.putString(SUSHI_PREFIX + "review_content_" + i, review.getContent());
        }
        editor.apply();
