 ...
 * JavaActivityReview will allow userss to write and view reviews for javacity
 */
...
public class JavaActivityReview extends AppCompatActivity implements View.OnClickListener{
    private static final String PREFS_NAME = "JavaReviewPrefs";
    private static final String KEY_REVIEW_COUNT = "ReviewCount";
    private static final String JAVA_PREFIX = "java_";

    private LinearLayout reviewContainer;
    private List<JavaReview> reviewList;
    ...
    private void displayReviews() {
        for(JavaReview reviews : reviewList){
    ...
    private void loadReviewsFromPreferences() {
        ...
        for(int i = 0; i < reviewCount; i++){
            String title = sharedPreferences.getString(JAVA_PREFIX + "review_title_" + i, "");
            String content = sharedPreferences.getString(JAVA_PREFIX + "review_content_" + i, "");
    ...
    /**
     *
     * @return get users email from sharedpreferences
     */
    ...
    /**
     * clear input fiels when review is posted
     */
    ...
    /**
     *
     * @param review create view for review
     */
    private void createReviewView(final JavaReview review) {
    ...
    /**
     *
     * @param review show a delete dialog to make sure they want to delete review
     */
    private void showDeleteDialog(final JavaReview review) {
     ...
     */
    private void deleteReviewAndRefresh(JavaReview review) {
    ...
    private void saveReviewsToPreferences() {
        ...
        for(int i = 0; i < reviewList.size(); i++){
            JavaReview review = reviewList.get(i);
            editor.putString(JAVA_PREFIX + "review_title_" + i, review.getTitle());
            editor.putString(JAVA_PREFIX + "review_content_" + i, review.getContent());
        }
        editor.apply();
