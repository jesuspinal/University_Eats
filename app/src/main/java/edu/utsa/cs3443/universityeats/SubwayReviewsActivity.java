...
public class SubwayReviewsActivity extends AppCompatActivity implements View.OnClickListener{
    private static final String PREFS_NAME = "SubwayReviewPrefs";
    private static final String KEY_REVIEW_COUNT = "ReviewCount";
    private static final String SUBWAY_PREFIX = "subway_";

    private LinearLayout reviewContainer;
    private List<SubwayReviews> reviewList;
    ...
    private void displayReviews() {
        for(SubwayReviews reviews : reviewList){
    ...
    private void loadReviewsFromPreferences() {
        ...
        for(int i = 0; i < reviewCount; i++){
            String title = sharedPreferences.getString(SUBWAY_PREFIX + "review_title_" + i, "");
            String content = sharedPreferences.getString(SUBWAY_PREFIX + "review_content_" + i, "");

            SubwayReviews review = new SubwayReviews();
    ...
    private void createReviewView(final SubwayReviews review) {
    ...
    private void showDeleteDialog(final SubwayReviews review) {
    ...
    private void deleteReviewAndRefresh(SubwayReviews review) {
    ...
    private void saveReviewsToPreferences() {
        ...
        for(int i = 0; i < reviewList.size(); i++){
            SubwayReviews review = reviewList.get(i);
            editor.putString(SUBWAY_PREFIX + "review_title_" + i, review.getTitle());
            editor.putString(SUBWAY_PREFIX + "review_content_" + i, review.getContent());
        }
        editor.apply();
