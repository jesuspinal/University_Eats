 ...
 * FreebirdsActivity will display info about freebirds, including reviews fromm users.
 * set up the navigation here to submit review or go to home screen
 *
 */
...
public class FreebirdsActivity extends AppCompatActivity implements View.OnClickListener{
    Button reviewButton;
    Button homeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freebirds);
        ...
        List<FreebirdReview> reviewsList = FreebirdReview.readReviewsFromCSV(this);

        // Update the TextView with the information
        StringBuilder reviewsText = new StringBuilder();
        for (FreebirdReview review : reviewsList) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.reviewButton) {
            i = new Intent(this, FreebirdActivityReview.class);
            startActivity(i);
        }
