...
public class SushicActivity extends AppCompatActivity implements View.OnClickListener{
    Button reviewButton;
    Button homeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sushic);
        ...
        List<SushiReview> reviewsList = SushiReview.readReviewsFromCSV(this);

        // Update the TextView with the information
        StringBuilder reviewsText = new StringBuilder();
        for (SushiReview review : reviewsList) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.reviewButton) {
            i = new Intent(this, SushiReviewActivity.class);
            startActivity(i);
        }
